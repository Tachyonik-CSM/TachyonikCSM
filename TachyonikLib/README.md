...
| `textextract` | Turns an uploaded file into the text that analysis and import routines match against. Text formats pass through unchanged; a PDF's text layer is extracted, bounded at both ends (see below). Best-effort and never fatal. |
